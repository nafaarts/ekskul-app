<x-app-layout>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('pendaftar.update', $pendaftar) }}" method="POST">
                @csrf
                @method('patch')
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <x-text-input id="nama" name="nama" type="text" class="mt-1 block w-full"
                                :value="old('nama', $pendaftar->nama)" autofocus autocomplete="nama" />
                        ...
                        <div class="col">
                            ...
                            <x-text-input id="tgl_lahir" name="tgl_lahir" type="date" class="mt-1 block w-full"
                                :value="old('tgl_lahir', $pendaftar->tgl_lahir)" autocomplete="tgl_lahir" />
                        ...
                        <div class="col">
                            ...
                            <select class="form-select mt-1" name="ekstrakurikuler_id" id="ekstrakurikuler">
                                @foreach ($ekstrakurikuler as $item)
                                    <option value="{{ $item->id }}" @selected($pendaftar->ekstrakurikuler_id == $item->id)>{{ $item->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col">
                            ...
                            <select class="form-select mt-1" name="kelas_id" id="kelas">
                                @foreach ($kelas as $item)
                                    <option value="{{ $item->id }}" @selected($pendaftar->kelas_id == $item->id)>{{ $item->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col">
                            <div>
                                ...
                                <x-text-input id="nisn" name="nisn" type="text" class="mt-1 block w-full"
                                    :value="old('nisn', $pendaftar->nisn)" autocomplete="nisn" />
                        ...
                        <div class="col">
                            <div>
                                ...
                                <x-text-input id="no_hp" name="no_hp" type="text" class="mt-1 block w-full"
                                    :value="old('no_hp', $pendaftar->no_hp)" autocomplete="no_hp" />
